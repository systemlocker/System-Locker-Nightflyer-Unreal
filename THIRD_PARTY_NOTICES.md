...
live alongside the code under `Source/SystemLockerNightflyer/Private/Vendor/`;
...
`Vendor/ed25519/LICENSE.txt`. The module adds strict point, torsion, and
scalar canonicality checks around the vendored verifier, matching the
System Locker client protocol requirements.
...
2-clause license — see `Vendor/micro-ecc/LICENSE.txt`. Used for installation
...
`Vendor/nlohmann/LICENSE.MIT`. Used with strict parsing settings (duplicate
